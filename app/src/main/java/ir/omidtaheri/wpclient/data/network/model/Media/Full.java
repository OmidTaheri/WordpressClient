...
public class Full implements Parcelable
{
    ...
    public final static Creator<Full> CREATOR = new Creator<Full>() {
    ...
    public Full withFile(String file) {
        this.file = file;
        return this;
    }
    ...
    public Full withMimeType(String mimeType) {
        this.mimeType = mimeType;
        return this;
    }
    ...
    public Full withSourceUrl(String sourceUrl) {
        this.sourceUrl = sourceUrl;
        return this;
    }
