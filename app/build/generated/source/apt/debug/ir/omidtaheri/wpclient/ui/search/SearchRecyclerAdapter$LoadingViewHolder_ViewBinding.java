...
public class SearchRecyclerAdapter$LoadingViewHolder_ViewBinding implements Unbinder {
  private SearchRecyclerAdapter.LoadingViewHolder target;

  @UiThread
  public SearchRecyclerAdapter$LoadingViewHolder_ViewBinding(SearchRecyclerAdapter.LoadingViewHolder target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    SearchRecyclerAdapter.LoadingViewHolder target = this.target;
